...
namespace Unity.PerformanceTesting.Editor
{
    internal class TestRunBuilder : IPrebuildSetup, IPostBuildCleanup, IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        {
            // no-op: project doesn't use Unity.PerformanceTesting, and the original
            // body's live AssetDatabase.CreateFolder("Assets/Resources") call crashed
            // Unity's incremental compiler pipeline mid-build on iOS Cloud Build.
        }

        public void OnPostprocessBuild(BuildReport report)
        {
            // no-op: paired with the disabled OnPreprocessBuild above.
        }
